...
up, this phenomenon is called \emph{negative thermal expansion}\cite{Dubbeldam2007}.
...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/cited/mof5-bezene}
    \caption{A snapshot of the molecular dynamics simulation of benzene in MOF-5.
    A vapor–liquid coexistence takes place, the vapor and liquid phases extending
    over many unit cells. Image adapted from reference~\cite{Braun2015}.}
