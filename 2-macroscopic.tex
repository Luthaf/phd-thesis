...
us to gain high-level understanding of the processes at play. In this section,
...
the co-adsorption of multiple gases in the same porous framework, but that one
...
in a qualitative way why it is not possible, in flexible host frameworks, to
...
purpose, as it has only limited data at high loading (for pressures above 1 bar),
