...
Domino uses the \cxx11 version of \cxx standard, which brought major changes to
...
either Monte Carlo or molecular dynamics as \emph{first-class citizen}. We also
try to make it easy to use, and easy to extend, meaning it can be used as a
...
% et tu peux faire un lien avec les travaux de Johannes et les données ab initio
% sur lesquelles tu as bossé pour les ZIFs
