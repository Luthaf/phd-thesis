...
three isoreticular \ZIF8 frameworks is illustrated in a schematic way in
...
increase, in \ZIFCH3 and \ZIFCl the nitrogen molecules arrangement changes to a
...
between the three \ZIF8 derivatives comes from a difference in flexibility or
...
\ZIFCl and \ZIFCH3, thus preventing a molecular reordering to occur.
...
to parametrize a classical force field for \ZIFCH3, \ZIFCl and \ZIFBr using data
...
\emph{fragments}. For example methanoic acid \ce{HCO2H} would contain \ce{C-H},
\ce{C-O}, \ce{C=O}, and \ce{O-H} bond fragments; as well as \ce{H-C=O},
\ce{O-C=O}, \ce{C-O-H} angles and \ce{O=C-O-H} dihedral angle. The same
fragments would also be used in ethanoic acid \ce{CH3CO2H}, or any other
carboxylic acid.
