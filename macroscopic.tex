...
letting $W$ be the work received by a system during a transformation and $Q$ the
...
considering infinitesimal changes in $U$, $W$, and $Q$:
\[\d U = \delta Q + \delta W.\]
...
through Equation~\ref{eq:osmotic-potential}, allowing to predict which phase is
...
host matrices. All of this work is published in \citejournal{Fraux2018}\cite{Fraux2018}.
