...
\usepackage[
    pdfusetitle,
    % pdfauthor={Guillaume Fraux},
    pdftitle={Molecular simulation of fluid adsorption in flexible nanoporous materials at multiple scales},
    pdfsubject={PhD thesis},
    pdfkeywords={molecular simulation, flexible porous materials, intrusion, adsorption, multi-scale simulations},
...
% % Use this for the printed version, removing color from links
% \hypersetup{hidelinks}

% Create PDF version 1.4
\pdfminorversion=4
